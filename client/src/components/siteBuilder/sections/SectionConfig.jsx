import { Info, ShieldCheck, Truck, RotateCcw, FileText, Mail, MapPin } from "lucide-react"
import React from "react"

export const SECTIONS = [
    { id: "about", name: "About Us", icon: <Info size={16} /> },
    { id: "privacy", name: "Privacy Policy", icon: <ShieldCheck size={16} /> },
    { id: "shipping", name: "Shipping Policy", icon: <Truck size={16} /> },
    { id: "refund", name: "Refund Policy", icon: <RotateCcw size={16} /> },
    { id: "terms", name: "Terms of Service", icon: <FileText size={16} /> },
    { id: "contact", name: "Contact Us", icon: <Mail size={16} /> },
    { id: "location", name: "Location", icon: <MapPin size={16} /> }
]

export const DEFAULT_SECTIONS = {
    about: {
        show: true, color: "#000000", content:
